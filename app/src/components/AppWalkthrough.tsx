...
const FLOWS: Flow[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "Sign in first",
        body: "Lens uploads write to the active session's repo, so the Publish button stays disabled until you sign into a PDS via the Sessions menu (top-right). Granular OAuth means fieldwork only asks for the dev.panproto.schema.lens scope at curator tier or above.",
        tool: "lens",
        target: "[data-walk='session-menu']",
      },
    ],
